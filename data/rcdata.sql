...
INSERT INTO race (id, name, description, BaseHP, DamageBonus, CastingBonus, Vision, DefenseBonus, ToHitBonus, Stealth, MRBonus) VALUES (1, "Human", "A human", 100, 0, 0, 1, 0, 0, 0, 0);
...
INSERT INTO race (id, name, description, BaseHP, DamageBonus, CastingBonus, Vision, DefenseBonus, ToHitBonus, Stealth, MRBonus) VALUES (3, "Ogre", "A Ogre", 120, 5, -100, 2, -5, -5, -30, 5);
...
INSERT INTO class (id, name, description, HPBonus, MinDamage, MaxDamage, BaseArmor, MageryType, Stealth, WeaponMessages, Speed, ClassType, SpellCasting, MR, Offense, Defense) VALUES (5, "Druid",     "A Druid",      0,    5,   15,   50,   4,   0,   5,   2,   1,  25,  60,  50, 80);
