...
-- Weapon Messages
INSERT INTO messages (id, message, BriefDesc, MessageType) values (1, "%sYou swing your axe at %s, but miss!%s|%sYou chop %s for %i damage!%s|%sYou surprise chop %s for %i damage!%s|%s%s swings at you with an axe, but misses!%s|%s%s chops you for %i damage!%s|%s%s surprise chops you for %i damage!%s|%s%s swings at %s, but misses!%s|%s%s chops %s for %i damage!%s|%s%s surprise chops %s for %i damage!%s", "Weapon messages for Barbarian", 1);
