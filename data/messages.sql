...
INSERT INTO messages (id, message, BriefDesc, MessageType) values (3, "%sYou swing your shortsword at %s, but miss!%s|%sYou slice %s for %i damage!%s|%s%s swings at you with a shortsword, but misses!%s|%s%s slices you for %i damage!|%s swings at %s, but misses!%s|%s%s slices %s for %i damage!%s", "Weapon messages for thief", 1);
